--- portmidi/portmidi/porttime/ptfreebsd.c.orig	2022-03-24 01:31:06 UTC
+++ portmidi/portmidi/porttime/ptfreebsd.c
@@ -0,0 +1,134 @@
+/* ptfreebsd.c -- portable timer implementation for FreeBSD, modified from Linux version */
+
+
+/* IMPLEMENTATION NOTES (by Mark Nelson): 
+
+Unlike Windows, FreeBSD has no system call to request a periodic callback,
