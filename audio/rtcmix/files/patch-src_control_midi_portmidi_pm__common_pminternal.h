--- src/control/midi/portmidi/pm_common/pminternal.h.orig	2022-06-20 19:29:55 UTC
+++ src/control/midi/portmidi/pm_common/pminternal.h
@@ -1,4 +1,4 @@
...
@@ -42,37 +48,37 @@ typedef PmError (*pm_write_byte_fn)(struct pm_internal
...
-} PmQueueRep;
 ...
 void pm_init(void); 
@@ -145,32 +153,35 @@ void pm_term(void); 
