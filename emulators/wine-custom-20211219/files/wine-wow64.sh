...
if [ -e $LOCALBASE/lib/wine/winealsa.drv.so ]; then
...
#$LOCALBASE/lib/wine/wineoss.drv.so $I386_ROOT/$LOCALBASE/lib/wine/wineoss.drv.so
#$LOCALBASE/lib/wine/winealsa.drv.so $I386_ROOT/$LOCALBASE/lib/wine/winealsa.drv.so
else
export LD_32_LIBMAP="
$LOCALBASE/lib/libvulkan_intel.so  $I386_ROOT/$LOCALBASE/lib/libvulkan_intel.so
$LOCALBASE/lib/libvulkan_radeon.so $I386_ROOT/$LOCALBASE/lib/libvulkan_radeon.so
