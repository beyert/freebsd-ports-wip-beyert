--- authfd.c.orig	2018-11-25 15:34:22 UTC
+++ authfd.c
@@ -207,15 +207,22 @@ deserialise_identity1(struct sshbuf *ids, struct sshke
 	int r, keybits;
 	u_int32_t bits;
 	char *comment = NULL;
...
@@ -393,15 +400,17 @@ ssh_decrypt_challenge(int sock, struct sshkey* key, BI
 	struct sshbuf *msg;
 	int r;
 	u_char type;
+	const BIGNUM *e, *n;
