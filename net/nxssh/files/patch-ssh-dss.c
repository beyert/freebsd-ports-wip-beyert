--- ssh-dss.c.orig	2018-11-25 15:34:22 UTC
+++ ssh-dss.c
@@ -55,6 +55,7 @@ ssh_dss_sign(const struct sshkey *key, u_char **sigp, 
...
+	const BIGNUM *r, *s;
 	...
 	if (lenp != NULL)
 		*lenp = 0;
@@ -76,15 +77,16 @@ ssh_dss_sign(const struct sshkey *key, u_char **sigp, 
 		goto out;
 	}
