--- ssh-ecdsa.c.orig	2018-11-25 15:34:22 UTC
+++ ssh-ecdsa.c
@@ -54,6 +54,7 @@ ssh_ecdsa_sign(const struct sshkey *key, u_char **sigp
 	size_t len, dlen;
...
+	const BIGNUM *r, *s;
 	...
 	if (lenp != NULL)
 		*lenp = 0;
@@ -80,8 +81,9 @@ ssh_ecdsa_sign(const struct sshkey *key, u_char **sigp
