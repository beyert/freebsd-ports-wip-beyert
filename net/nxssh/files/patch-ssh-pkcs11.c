--- ssh-pkcs11.c.orig	2018-11-25 15:34:22 UTC
+++ ssh-pkcs11.c
...
@@ -326,13 +326,21 @@ pkcs11_rsa_wrap(struct pkcs11_provider *provider, CK_U
...
@@ -460,6 +468,7 @@ pkcs11_fetch_keys_filter(struct pkcs11_provider *p, CK
 	CK_ULONG		nfound;
...
@@ -512,10 +521,14 @@ pkcs11_fetch_keys_filter(struct pkcs11_provider *p, CK
 			if ((rsa = RSA_new()) == NULL) {
...
+					error("RSA_set0_key failed");
 			...
 			cp = attribs[2].pValue;
@@ -525,17 +538,18 @@ pkcs11_fetch_keys_filter(struct pkcs11_provider *p, CK
 			    == NULL) {
